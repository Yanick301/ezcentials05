                ...
                <div className="mt-8">
                  <div className="rounded-lg border border-border bg-card p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between"><span className="font-medium text-foreground"><TranslatedText fr="Titulaire du compte" en="Account Holder">Kontoinhaber</TranslatedText>:</span> <span className="text-foreground">Sebastian Fassbender</span></div>
                      <div className="flex justify-between"><span className="font-medium text-foreground">IBAN:</span> <span className="text-foreground">DE05202208000045955091</span></div>
                      <div className="flex justify-between"><span className="font-medium text-foreground">BIC:</span> <span className="text-foreground">SXPYDEHHXXX</span></div>
                      <div className="flex justify-between"><span className="font-medium text-foreground"><TranslatedText fr="Banque" en="Bank">Bank</TranslatedText>:</span> <span className="text-foreground">Kontotyp</span></div>
