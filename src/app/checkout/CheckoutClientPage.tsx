                ...
                <div className="mt-8">
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between"><span className="font-medium text-foreground"><TranslatedText fr="Titulaire du compte" en="Account Holder">Klaus</TranslatedText>:</span> <span className="text-foreground">Peter Scheid</span></div>
