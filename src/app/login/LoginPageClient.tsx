...
export default function LoginPageClient() {
  ...
  const currentSchema = loginSchemaDE;
    ...
    try {
      ...
      if (authData.user && !authData.user.email_confirmed_at) {
        toast({
          ...
          description: "Bitte bestätigen Sie Ihre E-Mail, bevor Sie sich anmelden.",
        });
    ...
    <div className="flex min-h-[calc(100vh-80px)] w-full flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-sm rounded-2xl border-none shadow-lg">
        <CardContent className="p-8">
          <h2 className="mb-6 text-2xl font-semibold">Anmelden</h2>
          <Form {...form}>
